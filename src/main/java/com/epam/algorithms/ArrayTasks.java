...
public class ArrayTasks {
    ...
    public int[] getOnlyPositiveNumbers(int[] arr) {
        ...
        // create a new array with the same length as the count of positive numbers
        int[] result = new int[count];

        // iterate through the original array and add positive numbers to the new array
        int index = 0;
        for (int i = 0; i < arr.length; i++) {
            if (arr[i] > 0) {
                result[index] = arr[i];
        ...
        // return the new array with only positive numbers
        return result;
    }
    ...
    public int[][] sortRaggedArray(int[][] arr) {
        // Sort the incoming one-dimensional arrays by their length using bubble sort
        for (int i = 0; i < arr.length; i++) {
        ...
        // Sort the numbers in each one-dimensional array in ascending order using bubble sort
        for (int i = 0; i < arr.length; i++) {
